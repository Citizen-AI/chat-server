...
envalid.cleanEnv(process.env, {
  ...
  fb_page_token: str({ desc: 'Facebook Page Access Token (get from https://developers.facebook.com/ > your app > Messenger > Settings > Access Tokens > Generate Token' }),
  fb_verify_token: str({ desc: 'Facebook Verify Token  (get from https://developers.facebook.com/ > your app > Messenger > Settings > Webhooks > Edit Callback URL)' }),
